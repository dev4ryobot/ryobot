            ...
            if selected == actual:
                ...
                if not on_cooldown:
                    if new_streak < 40:
                        ...
                        # Streak >= 40: Add 1.6k paint and 8 glue for every 10 streak level
                        tier = (new_streak // 10) - 4  # t=0 for 40-49, t=1 for 50-59, etc.
                        reward_paint = 1600 + tier * 1600
                        reward_glue = 0
                        
                        # Glue bonus on exactly every 10-streak milestone
                        if new_streak % 10 == 0:
