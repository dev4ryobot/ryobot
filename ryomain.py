...
@bot.tree.command(name="binder", description="View your photocard binders")
@app_commands.describe(
    user="The user whose binder you want to view",
    binder_name="Optional specific binder name to view"
)
async def binder_cmd(
    ...
    await bindershow_cmd(interaction, user, binder_name)
...
@binder_cmd.autocomplete('binder_name')
@safe_autocomplete
